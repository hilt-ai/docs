...
| Table | Writer | ML use |
| --- | --- | --- |
| `dag_anomaly_scores` | [`scorewriter.go`](https://github.com/hilt-ai/dag-enrichment/blob/dev/internal/scoring/scorewriter.go) | 24 raw numeric features + 32 derived features + 21 per-feature z-scores per host/epoch (named columns) |
